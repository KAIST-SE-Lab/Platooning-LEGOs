...
- Build the EV3 veihicle: [instruction](physical implementation/ev3-vehicle.pdf)
- Attach ultrasonic sensor and color sensor: [ultrasonic sensor](physical implementation/ev3-ultrasonic-sensor.pdf), [color sensor](physical implementation/ev3-color-sensor.pdf)
